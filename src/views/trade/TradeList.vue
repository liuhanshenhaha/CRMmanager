<template>
	<section>
			...
			<el-form :inline="true" :model="filters">
				...
				<el-col :span="3" :xs="24">
					<el-form-item class="w90p">
						<el-date-picker readonly v-model="filters.startDate" type="datetime" placeholder="选择开始日期时间"></el-date-picker>
					</el-form-item>
				</el-col>
				<el-col :span="3" :xs="24">
					<el-form-item class="w90p">
						<el-date-picker readonly :picker-options="{pickerOptionsEnd}" v-model="filters.endDate" type="datetime" placeholder="选择结束日期时间"></el-date-picker>
					</el-form-item>
				</el-col>
				<el-col :span="3" :xs="24">
					<el-form-item>
		...
		<el-table stripe border fixed :data="tableData" highlight-current-row v-loading="listLoading" @selection-change="" style="width: 100%;">
			...
			<el-table-column prop="sxf" label="手续费" width="150">
			</el-table-column>
	...
	export default {
		...
		methods:{
			...
			getList(pageNo){
				...
				submitData.superiorUserId = this.filters[this.filters.length - 1];
