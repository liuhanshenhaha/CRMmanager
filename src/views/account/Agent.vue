<template>
	<section>
		...
		<el-table stripe border fixed :data="tableData" highlight-current-row v-loading="listLoading" @selection-change="" style="width: 100%;">
			<el-table-column prop="marketCode" label="账户" sortable width="100">
			</el-table-column>
			<el-table-column prop="marketName" label="姓名" sortable min-width="150">
			</el-table-column>
			<el-table-column prop="status" label="性别" sortable width="100" :formatter="statusFormat">
			</el-table-column>
			<el-table-column prop="remark" label="层级" sortable width="200">
			</el-table-column>
			<el-table-column prop="createBy" label="归属" sortable width="100">
			</el-table-column>
			<el-table-column prop="createTime" label="电话" sortable width="150" :formatter="dateFormat">
			</el-table-column>
			<el-table-column prop="modifyBy" label="邮箱" sortable width="100">
			</el-table-column>
			<el-table-column prop="modifyTime" label="身份证信息" sortable width="150" :formatter="dateFormat">
			</el-table-column>
			<el-table-column prop="modifyTime" label="银行" sortable width="150" :formatter="dateFormat">
			</el-table-column>
			<el-table-column prop="modifyTime" label="银行卡号" sortable width="150" :formatter="dateFormat">
			</el-table-column>
			<el-table-column prop="modifyTime" label="开户行地址" sortable width="150" :formatter="dateFormat">
			</el-table-column>
			<el-table-column prop="modifyTime" label="开户时间" sortable width="150" :formatter="dateFormat">
			</el-table-column>
